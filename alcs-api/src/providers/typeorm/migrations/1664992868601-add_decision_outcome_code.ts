...
export class addDecisionOutcomeCode1664992868601 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "application_decision" ADD CONSTRAINT "FK_cd7126f6177b068f58e05d47b8f" FOREIGN KEY ("outcome_uuid") REFERENCES "application_decision_outcome_type"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(`INSERT INTO "public"."application_decision_outcome_type"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "application_decision_outcome_type"`);
  }
}
