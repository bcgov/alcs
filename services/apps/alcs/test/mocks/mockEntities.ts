...
import { CardStatus } from '../../src/card/card-status/card-status.entity';
import { CardSubtaskType } from '../../src/card/card-subtask/card-subtask-type/card-subtask-type.entity';
import { CardSubtask } from '../../src/card/card-subtask/card-subtask.entity';
import { CardType } from '../../src/card/card-type/card-type.entity';
import { Card } from '../../src/card/card.entity';
import { ApplicationMeetingType } from '../../src/code/application-code/application-meeting-type/application-meeting-type.entity';
import { ApplicationRegion } from '../../src/code/application-code/application-region/application-region.entity';
