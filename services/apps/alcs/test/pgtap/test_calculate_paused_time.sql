...
prepare insert_application_region_in_test_calculate_paused AS
    INSERT INTO alcs.application_region (audit_created_by,audit_updated_by,code,description,"label",audit_deleted_date_at,audit_created_at,audit_updated_at) VALUES
        ('migration_seed',NULL,'TEST','Application test st','Incoming / Prelim Review',NULL,'2022-07-25 14:30:38.573',NULL);
...
INSERT INTO alcs.board (uuid,audit_deleted_date_at,audit_created_at,audit_updated_at,audit_created_by,audit_updated_by,code,title) VALUES
	 ('11111111-1111-1111-1111-111111111111',NULL,'2022-08-24 13:49:58.829', NULL,'unit_test',NULL,'mock','Mock Panel');
...
INSERT INTO alcs.card (uuid,audit_deleted_date_at,audit_created_at,audit_updated_at,audit_created_by,audit_updated_by,high_priority,status_code,board_uuid,assignee_uuid,created_at,type_code) VALUES
	 ('11111111-1111-1111-1111-111111111111',NULL,'2022-10-03 14:39:17.968667-07', NULL,'unit_test',NULL,false,'TEST','11111111-1111-1111-1111-111111111111',NULL,'2022-10-03 14:39:17.968667-07','MOCK'),
	 ('22222222-2222-2222-2222-222222222222',NULL,'2022-10-03 14:39:17.968667-07', NULL,'unit_test',NULL,false,'TEST','11111111-1111-1111-1111-111111111111',NULL,'2022-10-03 14:39:17.968667-07','MOCK'),
	 ('33333333-3333-3333-3333-333333333333',NULL,'2022-10-03 14:39:17.968667-07', NULL,'unit_test',NULL,false,'TEST','11111111-1111-1111-1111-111111111111',NULL,'2022-10-03 14:39:17.968667-07','MOCK'),
	 ('44444444-4444-4444-4444-444444444444',NULL,'2022-10-03 14:39:17.968667-07', NULL,'unit_test',NULL,false,'TEST','11111111-1111-1111-1111-111111111111',NULL,'2022-10-03 14:39:17.968667-07','MOCK'),
	 ('55555555-5555-5555-5555-555555555555',NULL,'2022-10-03 14:39:17.968667-07', NULL,'unit_test',NULL,false,'TEST','11111111-1111-1111-1111-111111111111',NULL,'2022-10-03 14:39:17.968667-07','MOCK');
...
INSERT INTO alcs.application_paused (uuid,audit_deleted_date_at,audit_created_at,audit_updated_at,audit_created_by,audit_updated_by,start_date,end_date,application_uuid) VALUES
...
PREPARE actual_result_no_dates AS SELECT * from alcs.calculate_active_days('{11111111-1111-1111-1111-111111111111}'::uuid[]);
...
SELECT override.freeze_time('2022-08-02');
PREPARE actual_result_1_week_with_holiday_no_pause AS SELECT * from alcs.calculate_active_days('{22222222-2222-2222-2222-222222222222}'::uuid[]);
...
SELECT override.freeze_time('2022-08-02');
PREPARE actual_result_1_week_with_holiday_with_pause AS SELECT * from alcs.calculate_active_days('{33333333-3333-3333-3333-333333333333}'::uuid[]);
...
PREPARE actual_result_1_week_with_holiday_with_overlap_pause AS SELECT * from alcs.calculate_active_days('{33333333-3333-3333-3333-333333333333}'::uuid[]);
...
PREPARE actual_result_paused_and_active_holiday AS SELECT * from alcs.calculate_active_days('{44444444-4444-4444-4444-444444444444}'::uuid[]);
...
PREPARE actual_result_with_decision_date AS SELECT * from alcs.calculate_active_days('{55555555-5555-5555-5555-555555555555}'::uuid[]);
