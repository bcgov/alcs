...
export class CreateConditionStatusFunction1733518433153 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP FUNCTION IF EXISTS alcs.get_current_status_for_application_condition(uuid);`);
        await queryRunner.query(`DROP FUNCTION IF EXISTS alcs.get_current_status_for_noi_condition(uuid);`);
    }
