...
export class missingRegionCode1694794266666 implements MigrationInterface {
  name = 'missingRegionCode1694794266666';
...
`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP VIEW "alcs"."non_application_search_view"`);
    await queryRunner.query(`CREATE VIEW "alcs"."non_application_search_view" AS SELECT
        non_applications."uuid"
        ,non_applications."file_number"
        ,non_applications."applicant" 
        ,non_applications."type"
