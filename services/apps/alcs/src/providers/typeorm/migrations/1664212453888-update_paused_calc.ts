...
export class updatePausedCalc1664212453888 implements MigrationInterface {
  name = 'updatePausedCalc1664212453888';
      ...
      FROM ( --Load each pause for application with each having its own count of weekdays and holidays
        ...
        FROM (
          ...
          FROM
            ...
            INNER JOIN application_paused t1 ON s1.start_date <= t1.end_date
