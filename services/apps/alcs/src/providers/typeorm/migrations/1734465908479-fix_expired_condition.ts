...
export class FixExpiredCondition1734465908479 implements MigrationInterface {
                                        ...
                                        BEGIN
                                            ...
                                            LOOP
                                                ...
                                                ELSE
                                                    ...
                                                    IF (date_record.date::date >= utc_timestamp_today::date OR date_record.date IS NULL) THEN
                                                        is_pending = true;
                                                    END IF;
                                                    ...
                                                    IF (date_record.date::date < utc_timestamp_today::date AND date_record.single_date_label = 'End Date') THEN
                                                        is_expired = true;
                                                    END IF;
                                                END IF;
                                            END LOOP;
