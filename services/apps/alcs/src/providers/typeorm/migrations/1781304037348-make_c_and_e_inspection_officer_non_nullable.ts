...
export class MakeCAndEInspectionOfficerNonNullable1781304037348 implements MigrationInterface {
  name = 'MakeCAndEInspectionOfficerNonNullable1781304037348';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "alcs"."compliance_and_enforcement_chronology_inspection" ALTER COLUMN "officer_uuid" SET NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "alcs"."compliance_and_enforcement_chronology_inspection" ALTER COLUMN "officer_uuid" DROP NOT NULL`,
    );
    await queryRunner.query(
