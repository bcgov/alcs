...
export class SetPurposeOnAppNoiFromOats1707848440329
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ...
            SELECT
                ...
                CASE 
                    WHEN length(proposal_background_desc) > 10 THEN pb.proposal_summary_desc || ' . Bckground: ' || pb.proposal_background_desc
