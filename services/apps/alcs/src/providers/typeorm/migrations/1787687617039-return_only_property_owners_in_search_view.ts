...
export class ReturnOnlyPropertyOwnersInSearchView1787687617039 implements MigrationInterface {
  name = 'ReturnOnlyPropertyOwnersInSearchView1787687617039';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE VIEW "alcs"."compliance_and_enforcement_search_view" AS SELECT "cae"."uuid" AS "uuid", "lg"."name" AS "local_government_name", "cae"."file_number" AS "file_number", "cae"."date_submitted" AS "date_submitted", "caep"."civic_address" AS "civic_address", case
          ...
          filter (where "caerp"."uuid" is not null and "caerp"."party_type" = 'Property Owner') AS "responsible_parties", case
        ...
        end AS "is_open" FROM "alcs"."compliance_and_enforcement" "cae" LEFT JOIN "alcs"."compliance_and_enforcement_property" "caep" ON "caep"."file_uuid" = "cae"."uuid"  LEFT JOIN "alcs"."compliance_and_enforcement_responsible_party" "caerp" ON "caerp"."file_uuid" = "cae"."uuid"  LEFT JOIN "alcs"."compliance_and_enforcement_responsible_party_director" "caerpd" ON "caerpd"."responsible_party_uuid" = "caerp"."uuid"  LEFT JOIN "alcs"."local_government" "lg" ON  "lg"."uuid" = "caep"."local_government_uuid" AND "lg"."audit_deleted_date_at" IS NULL WHERE "cae"."audit_deleted_date_at" IS NULL GROUP BY "cae"."uuid", "caep"."civic_address", "caep"."ownership_type_code", "lg"."name"`);
    await queryRunner.query(
