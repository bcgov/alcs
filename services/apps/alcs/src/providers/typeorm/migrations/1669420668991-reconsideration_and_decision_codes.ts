...
export class reconsiderationAndDecisionCodes1669420668991
  implements MigrationInterface
{
  name = 'reconsiderationAndDecisionCodes1669420668991';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "alcs"."application_modification" ADD "review_outcome_code" text NOT NULL DEFAULT 'PEN';`,
    );
