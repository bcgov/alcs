...
export class addNoiDocs1691007382208 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "alcs"."noi_document" ADD CONSTRAINT "FK_703514379dc945f3bfc0d8e897d88086" FOREIGN KEY ("application_uuid") REFERENCES "alcs"."notice_of_intent"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`,
          );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "alcs"."noi_document" ALTER COLUMN "type_code" DROP NOT NULL`,
          );
        await queryRunner.query(
