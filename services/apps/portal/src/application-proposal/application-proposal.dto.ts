...
export class ApplicationProposalDto {
  @AutoMap()
  fileNumber: string;
...
export class ApplicationProposalDetailedDto extends ApplicationProposalDto {
  @AutoMap()
...
export class ApplicationProposalCreateDto {
  @IsString()
  @IsNotEmpty()
  type: string;
}

export class ApplicationProposalUpdateDto {
  @IsString()
  @IsOptional()
  applicant?: string;
