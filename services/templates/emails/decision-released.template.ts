  ...
  <mj-body width="600px">
    ...
    <mj-section background-color="white" padding="48px 0px 48px 0px">
      <mj-column width="600px" css-class='line-height'>
        ...
        <mj-text font-size='16px'>
          Please log into the ALC Portal to view the Reasons for Decision. The document can be found by clicking 'View' from the Inbox table and then navigating to the 'ALC Review and Decision' tab. The Reasons for Decision will be available to the public on {{ decisionReleaseMaskedDate }}. 
        </mj-text>
        <mj-text font-size='16px'>
