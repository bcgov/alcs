...
describe('NoticeOfIntentOwnerService', () => {
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(NoticeOfIntentOwnerService);
  });
  ...
  it('should make a get request for loading owners', async () => {
    ...
    expect(mockHttpClient.get.mock.calls[0][0]).toContain('notice-of-intent-owner');
  });
  ...
  it('should make a post request for create', async () => {
    ...
    expect(mockHttpClient.post.mock.calls[0][0]).toContain('notice-of-intent-owner');
  });
  ...
  it('should make a patch request for update', async () => {
    ...
    expect(mockHttpClient.patch.mock.calls[0][0]).toContain('notice-of-intent-owner');
  });
  ...
  it('should make a delete request for delete', async () => {
    ...
    expect(mockHttpClient.delete.mock.calls[0][0]).toContain('notice-of-intent-owner');
  });
