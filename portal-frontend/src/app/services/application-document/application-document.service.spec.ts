...
describe('ApplicationDocumentService', () => {
  ...
  it('should make a patch request for update file', async () => {
    ...
    expect(mockHttpClient.patch.mock.calls[0][0]).toContain('application-document');
  });
  ...
  it('should make a get request for get by file id', async () => {
    mockHttpClient.get.mockReturnValue(of({}));
  ...
  it('should show an error toast if get by file id fails', async () => {
    mockHttpClient.get.mockReturnValue(throwError(() => ({})));
