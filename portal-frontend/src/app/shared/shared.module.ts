...
import { StructureMobileCardComponent } from '../features/notice-of-intents/edit-submission/additional-information/structure-mobile-card/structure-mobile-card.component';
