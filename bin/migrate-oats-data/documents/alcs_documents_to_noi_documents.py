...
"""
    This script links data from ALCS documents table to ALCS notice_of_intent_document table based on data from OATS.
"""
...
@inject_conn_pool
def link_alcs_docs_to_noi_docs(conn=None, batch_size=BATCH_UPLOAD_SIZE):
    """
