...
etl_name = "process_alcs_notice_of_intent_submitted_to_alc_status"
logger = setup_and_get_logger(etl_name)


@inject_conn_pool
def process_alcs_notice_of_intent_submitted_to_alc_status(
    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cursor:
        with open(
            "noi/sql/notice_of_intent_submission/statuses/submitted_to_alc/notice_of_intent_status_submitted_to_alc_count.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
        ...
        with open(
            "noi/sql/notice_of_intent_submission/statuses/submitted_to_alc/notice_of_intent_status_submitted_to_alc.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
