...
etl_name = "process_alcs_notice_of_intent_cancelled_status"
logger = setup_and_get_logger(etl_name)


@inject_conn_pool
def process_alcs_notice_of_intent_cancelled_status(
    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cursor:
        with open(
            "noi/sql/notice_of_intent_submission/statuses/cancelled/notice_of_intent_status_cancelled_count.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
        ...
        with open(
            "noi/sql/notice_of_intent_submission/statuses/cancelled/notice_of_intent_status_cancelled.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
