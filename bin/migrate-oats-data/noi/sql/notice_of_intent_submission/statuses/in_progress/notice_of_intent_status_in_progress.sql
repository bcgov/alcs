...
earliest_in_progress_accomplishments_for_noi_only AS (
    SELECT DISTINCT ON (
...
FROM alcs.notice_of_intent_submission_to_submission_status noistss
    ...
    JOIN earliest_in_progress_accomplishments_for_noi_only AS oats_in_prog ON oats_in_prog.alr_application_id::TEXT = nois.file_number