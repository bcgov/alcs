...
from .command_parser.document_command_parser import (
    ...
    pr_document_import_command_parser,
    pr_document_clean_command_parser,
)
...
def setup_menu_args_parser(import_batch_size):
    ...
    pr_document_import_command_parser(import_batch_size, subparsers)
    pr_document_clean_command_parser(subparsers)
