...
etl_name = "srw_staff_journal"
logger = setup_and_get_logger(etl_name)


@inject_conn_pool
def process_srw_staff_journal(conn=None, batch_size=BATCH_UPLOAD_SIZE):
    """
    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cursor:
        with open(
            "srw/sql/srw_staff_journal_count.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
