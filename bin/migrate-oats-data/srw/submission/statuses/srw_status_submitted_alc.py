...
etl_name = "process_alcs_srw_submitted_to_alc_status"
logger = setup_and_get_logger(etl_name)


@inject_conn_pool
def process_alcs_srw_submitted_to_alc_status(conn=None, batch_size=BATCH_UPLOAD_SIZE):
    """
    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cursor:
        with open(
            "srw/sql/submission/statuses/srw_submitted_alc_count.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
        ...
        with open(
            "srw/sql/submission/statuses/srw_submitted_alc.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
