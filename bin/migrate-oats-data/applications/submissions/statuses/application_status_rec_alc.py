...
etl_name = "process_alcs_application_received_by_alc_status"
logger = setup_and_get_logger(etl_name)


@inject_conn_pool
def process_alcs_application_received_by_alc_status(conn=None):
    """
    This function is responsible for populating Received By ALC status of Applications in ALCS.
    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cursor:
        with open(
            "applications/submissions/sql/statuses/application_rec_by_alc_count.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
        ...
        with open(
            "applications/submissions/sql/statuses/application_rec_by_alc.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
