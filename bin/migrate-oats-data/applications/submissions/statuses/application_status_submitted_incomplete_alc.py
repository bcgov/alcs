...
etl_name = "process_alcs_application_submitted_to_alc_incomplete_status"
logger = setup_and_get_logger(etl_name)


@inject_conn_pool
def process_alcs_application_submitted_to_alc_incomplete_status(
    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cursor:
        with open(
            "applications/submissions/sql/statuses/application_incomplete_alc_count.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
        ...
        with open(
            "applications/submissions/sql/statuses/application_incomplete_alc.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
