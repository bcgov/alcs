...
etl_name = "process_alcs_application_decision_released_status"
logger = setup_and_get_logger(etl_name)


@inject_conn_pool
def process_alcs_application_decision_released_status(conn=None):
    """
    This function is responsible for populating Decision Released status of Application in ALCS.
    ...
    with conn.cursor(cursor_factory=RealDictCursor) as cursor:
        with open(
            "applications/submissions/sql/statuses/application_decision_released_count.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
        ...
        with open(
            "applications/submissions/sql/statuses/application_decision_released.sql",
            "r",
            encoding="utf-8",
        ) as sql_file:
