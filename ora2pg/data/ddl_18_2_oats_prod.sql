...
-- from ALR APPLICATION and ALR APPL DECISION.
(alr_application_id IS NOT NULL AND alr_appl_decision_id IS NULL)
...
-- supplied for a decision component.
(alr_appl_decision_id IS NOT NULL AND (decision_expiry_date IS NULL or decision_expiry_date IS NOT NULL)
)
...
CREATE UNIQUE INDEX oats_rlap_uk ON oats_related_alr_applications (primary_alr_application_id, secondary_alr_application_id);
