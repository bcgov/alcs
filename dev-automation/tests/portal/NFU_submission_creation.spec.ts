...
const password = "UQ-ZCDHi.FiF6c";
const filePathToUseAsUpload =
...
test("test", async ({ page }) => {
  ...
  await page
    .getByPlaceholder("Enter legal description")
  ...
  await page
    ...
    .check();
  await page
    .getByRole("button", { name: "Add another parcel to the application" })
    .click();
  await page.getByRole("textbox", { name: "Enter legal description" }).click();
  await page
    .getByRole("textbox", { name: "Enter legal description" })
  ...
  await page
    ...
    .click();
  await page
    .getByPlaceholder("Type ministry or department name")
    .fill("test ministry");
  ...
  await page
    .getByRole("button", { name: "Make Primary Contact" })
    .first()
    .click();
