...
describe('ApplicationReconsiderationService', () => {
  ...
  it('should be fetch reconsiderations and sort them by submittedDate', async () => {
    ...
    const res = await firstValueFrom(service.$reconsiderations);
  ...
  it('should call post for create', async () => {
    ...
    const res = await service.create({
      ...
      regionCode: '',
      reconTypeCode: '',
      reconsideredDecisionUuids: [],
      submittedDate: new Date(5),
      applicant: '',
    });
