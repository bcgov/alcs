...
import { DecisionConditionTypesService } from './decision-condition-types.service';

describe('DecisionConditionTypesService', () => {
  let service: DecisionConditionTypesService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(DecisionConditionTypesService);
  });
